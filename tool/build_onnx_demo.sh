...
BUILD_CMD_LINE="-DCMAKE_INSTALL_PREFIX=${PRJ_SUB_PATH}/install "
BUILD_CMD_LINE="${BUILD_CMD_LINE} -DCMAKE_BUILD_TYPE=${BUILD_TYPE} "
BUILD_CMD_LINE="${BUILD_CMD_LINE} ${PRJ_SUB_PATH} "
BUILD_CMD_LINE="${BUILD_CMD_LINE} -DBUILD_EXAMPLE_WITH_PCL=OFF "
